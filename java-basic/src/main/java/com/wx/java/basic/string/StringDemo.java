package com.wx.java.basic.string;
...
public class StringDemo {
    ...
    public  static void main(String[] args){
        ...
        //将两个字符串相加合成为一个新的字符串
        String c=a+b;
        System.out.println("字符串a，b合并后的内容为："+c);
        //查找某一子字符串是否被包含再此字符串中，如果包含，包含了多少次
        Scanner s3=new Scanner(System.in);
        System.out.println("请输入想要查找的字符串：");
        String d=s3.nextLine();
        //子字符串是否被包含在此字符串中，包含输出true，反之输出false
        boolean con=c.contains(d);
        System.out.println("子字符串时候被包含在此字符串中"+con);
        //调用count，输出包含次数
