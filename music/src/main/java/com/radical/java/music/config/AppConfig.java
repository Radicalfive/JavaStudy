package com.radical.java.music.config;

import com.radical.java.music.MusicApp;
...
public class AppConfig {
     ...
     */
    public static String title = "诗酒趁年华";
    /**
     * 应用默认图标
     */
    public static String icon = "icon/music.png";
    /**
     * 窗口默认宽度
     */
    ...
    public static void init() {
        try {
            ...
            InputStream in = MusicApp.class.getResourceAsStream("app.properties");
            properties.load(in);
