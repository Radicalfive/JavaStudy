...
import com.radical.netty.demo.domain.*;
import com.radical.netty.demo.util.CacheUtil;
import com.radical.netty.demo.util.FileUtil;
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        switch (fileTransferProtocol.getTransferType()) {
            ...
            case 2 -> {
                ...
                FileBurstInstruct fileBurstInstruct = FileUtil.writeFile("/Users/test/Desktop", fileBurstData);
